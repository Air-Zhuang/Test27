...
import os
import ConfigParser
path=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))+"\\test\\test.ini"
...
class getini(object):
    def __init__(self,path=None):
        if path==None:
            self.path=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))+"\\test\\test.ini"
        else:
            self.path=path
